...
function Questionnaietinyonelist ({item,deletedata}) {
    ...
    return (
        ...
        {visible && (
            <View style={{backgroundColor: '#fff', borderBottomColor: '#000', borderBottomWidth: 1 }}>
                <Menu.Item style={{marginLeft: 10}} leadingIcon="square-edit-outline" onPress={()=> router.push(`/admin/questionnaire/create-edit-tiny-qone?id=${item?.id}`)} title="Edit" />
...
export default Questionnaietinyonelist;