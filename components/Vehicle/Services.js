...
function Services () {
    ...
    const loaddata = () => {
        setLoading(true);
        axios.get(schoolzapi+'/services/'+user?.uniqueid,
        {
        ...
        return Alert.alert(
            ...
            [
              ...
              },
              {
                ...
                onPress: () => {
                    setLoading(true);
                    axios.get(schoolzapi+'/delete-services/'+id,
                    {
                        headers: {Accept: 'application/json'
                    }
                    })
      ...
      <SafeAreaView style={{flexGrow: 1}}>
        ...
        >
            ...
            <Card>
                ...
                <FlatList
                    data={filterdata}
                    renderItem={({item})=> <Servicelist item={item} deletedata={deletedata} /> }
        ...
        <FAB
          icon="plus"
          style={styles.fab}
          onPress={()=> router.push('/admin/create-edit-service')}
        />
      </SafeAreaView>
      </Provider>
    )
