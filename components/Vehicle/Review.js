...
function Review () {
    ...
    const loaddata = () => {
        setLoading(true);
        axios.get(schoolzapi+'/companys-info-review/'+user?.uniqueid,
        {
      ...
      <SafeAreaView style={{flexGrow: 1}}>
        ...
        >
            ...
            <Card>
                ...
                <FlatList
                    data={filterdata}
                    renderItem={({item})=> <Reviewlist item={item} deletedata={deletedata} /> }
        ...
        {/* <FAB
          icon="plus"
          style={styles.fab}
          onPress={()=> router.push('/admin/create-edit-vehicle')}
        /> */}
      </SafeAreaView>
      </Provider>
    )
